  ...
  return (
    <div className="container">
      <div className="header">
        <h1 className="book-title">🪶 CHAPTER CHASER 🪶</h1>
        <p className="book-quote">" Uncover the stories waiting on your shelf "</p>
      </div>
      ...
      {!query.trim()
        ? (<><h2 className="ink"> ☘︎ Inkspire Selection </h2>{renderBooks(recommendedBooks, RECOMMENDED_QUERY)}</>)
